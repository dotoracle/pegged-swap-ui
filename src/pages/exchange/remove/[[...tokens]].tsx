...
import { ChainId, Currency, NATIVE, Percent, WNATIVE } from 'dotoracle-sdk'
  ...
  async function onRemove() {
    ...
    if (approval === ApprovalState.APPROVED) {
      ...
      // removeLiquidity
        ...
        args = [tokenA.address, tokenB.address, liquidityAmount.quotient.toString(), account, deadline.toHexString()]
      }
    }
