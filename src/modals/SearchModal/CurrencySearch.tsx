import { ChainId, Currency, NATIVE, Token } from 'dotoracle-sdk'
    ...
    <ContentWrapper>
      ...
      <div className="mt-3 mb-8">
        <input
          ...
          className="w-full bg-transparent border border-dark-700 focus:border-dto-pink rounded placeholder-secondary focus:placeholder-primary font-semibold text-base px-6 py-3.5"
        />
      </div>
      {showCommonBases && (
        <div className="mb-4">
